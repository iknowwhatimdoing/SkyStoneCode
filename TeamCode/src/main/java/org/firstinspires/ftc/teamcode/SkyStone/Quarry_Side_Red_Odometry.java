...
public class Quarry_Side_Red_Odometry extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        goToPosition(-34,0 + patternOffsetY,.7,0,6.5);
        ...
        goToPosition(-16,0+patternOffsetY,.85,0,4);
