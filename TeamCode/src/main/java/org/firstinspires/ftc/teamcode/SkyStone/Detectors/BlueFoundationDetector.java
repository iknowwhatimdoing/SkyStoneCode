package org.firstinspires.ftc.teamcode.SkyStone.Detectors;
...
public class BlueFoundationDetector extends DogeCVDetector {
    ...
    public DogeCVColorFilter redFilter      = new LeviColorFilter(LeviColorFilter.ColorPreset.BLUE); //Red filter
    ...
    public Mat process(Mat input) {
        ...
        redFilter.process(workingMat.clone(),maskYellow);
